...
public class RJ_Options implements PlugIn, WindowListener {
	...
	public void run(String arg) {
		...
		if (floatout) RJ.log("Generating floating-point result images");
		else RJ.log("Generating result images of the same type as the input");
		
		if (adopt) RJ.log("Adopting brightness and contrast from input images");
		else RJ.log("Setting brightness and contrast based on full output range");
